...
-- 08. Students count
SELECT COUNT(s.id) AS `students_count`, u.name AS `university_name` FROM students AS s
...
DETERMINISTIC
RETURN(
	SELECT AVG(sc.grade) AS 'average_alumni_grade' FROM courses AS c
