...
# name = "5 starts"
# rooms = [("room1", 1), ("room2", 2), ("room3", 3)]
# guests = 10

# list_of_free_rooms = [x[0] for x in rooms]
# list_to_convert = []
# list_to_convert.append(f"Hotel {name} has {guests} total guests")
# list_to_convert.append("Free rooms: ")
# list_to_convert.extend(list_of_free_rooms)


# print(list_of_free_rooms)
...
# list_to_convert = []
# list_to_convert.append(f"Hotel {name} has {guests} total guests")
# free_rooms_header = "Free rooms: "
# free_rooms_list = [free_rooms_header] + list_of_free_rooms
# list_to_convert.extend(free_rooms_list)
